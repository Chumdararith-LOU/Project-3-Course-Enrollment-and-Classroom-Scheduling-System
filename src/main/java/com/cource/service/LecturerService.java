...
public interface LecturerService {
        ...
        // Attendance trends for a lecturer (counts per date within a date range)
        java.util.Map<String, Long> getAttendanceCountsByDateRange(long lecturerId, java.time.LocalDate from,
        ...
        double calculateAverageAttendance(long lecturerId, java.time.LocalDate from, java.time.LocalDate to,
                        Long offeringId, String studentStatus);

        java.util.List<LecturerCourseReportDTO> getCourseReports(long lecturerId, java.time.LocalDate from,
                        java.time.LocalDate to, String studentStatus);

        LecturerCourseDetailDTO getDetailedCourseReport(long lecturerId, long offeringId, java.time.LocalDate from,
                        java.time.LocalDate to, String studentStatus);
